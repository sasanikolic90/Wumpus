...
class Environment
{
    ...
    // pozicija wumpusa, pozicija zlata
    int wp,gp; 
    ...
    void accept(String w[][])
    {
        ...
        System.out.println("Test field is for now 4x4:");
        for(int i=1;i<=4;++i)
        {
            System.out.println("\n-----------------------------------------------------------------");
            System.out.print("|\t");
        ...
        System.out.println("\n-----------------------------------------------------------------");
        System.out.println("\nEnter starting position (13):");
        int start_pos = scr.nextInt();
        w[4][1]="A";
        System.out.println("Enter the number of pits:");
        np=scr.nextInt();
        pos=new int[np];
        System.out.println("WARNING! The position of pits and gold should not be the same.");
        System.out.println("Enter the position of the pits:");
        for(int i=0;i<np;++i)
        {
            pos[i]=scr.nextInt();
...
class wumpus
{
    ...
    out:for(int i=1;i<5;++i)
    {
        ...
        do
        {
            ...
            {
                complete=1;
                System.out.println("Easy! I found some gold!");
                break;
            }
                    ...
                    if(t[pos].bu!=1 && t[pos].u!=1 && (pos-4)>=1 &&  t[pos-4].doubt_pit<1 && t[pos-4].doubt_wump<1 && t[pos-4].pit!=1 && t[pos-1].wump!=1 && !(t[pos].back.contains("u") && (t[pos].l!=1 || t[pos].r!=1 || t[pos].d!=1) && check(t[pos])  ))
                    {
                        ...
                        if(t[pos].bd!=1 && t[pos].d!=1 && (pos+4)<=16 &&  t[pos+4].doubt_pit<1 && t[pos+4].doubt_wump<1 && t[pos+4].pit!=1 && t[pos+4].wump!=1)
                        {
                            ...
                            if(limit>50)
                            {
                                ...
                                System.out.println("\nCurrently I am at this position: "+temp3+".\nThinking...");
                                ...
                                t[pos].safe=1;
                                t[pos].visited=1;
                                System.out.println("Na poziciji: "+pos);
                                limit=0;
                            }
            ...
            if(t[pos].env.contains("P"))
            {
                score+=50;
                t[pos].pit=1;
                System.out.println("\n\nI fell in the pit at position: "+pos+".");
            }
        ...
        System.out.println("The result is: "+score+".\nNow I can go back to the start.");
